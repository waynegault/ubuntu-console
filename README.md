...
| Unit | `tests/unit/*.bats` | 296 | 120s | 600s |
...
│   ├── unit/                          # BATS unit tests (296 tests: 22+12+8+5+5+6+20+4+8+7+28+19+7+2+1+5+4+2+3+3+17+16+41+19+6+8+8+3+7)
