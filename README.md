...
│   ├── unit/                          # BATS unit tests (125 tests: 7+4+8+5+5+6+19+4+8+7+26+19+7)
│   └── integration/                   # BATS integration tests (124 tests: 14+42+10+27+5+26)
└── systemd/
