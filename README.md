...
│   ├── unit/                          # BATS unit tests (132 tests: 11+4+8+5+5+6+20+4+8+7+28+19+7)
│   └── integration/                   # BATS integration tests (144 tests: 14+43+10+44+5+28)
└── systemd/
