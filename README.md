...
│   ├── tactical-console-fast.bats     # Fast subset (57 tests, ~2 min)
...
│   └── integration/                   # BATS integration tests (122 tests: 14+42+10+25+5+26)
└── systemd/
