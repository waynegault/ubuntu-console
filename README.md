...
| Unit | `tests/unit/*.bats` | 234 | 120s | 600s |
...
│   ├── unit/                          # BATS unit tests (234 tests: 11+12+8+5+5+6+20+4+8+7+28+19+7+2+1+5+4+2+3+3+17+16+41)
