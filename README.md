...
- **Unit suites (66 tests overall):** CI runs `tests/unit/01`, `02`, `09`, `10`, `11`; nightly adds `05`–`08`. `04-llama-cpp-inventory` is excluded from both — it performs live downloads and mutates the host.
