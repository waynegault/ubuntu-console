...
| Unit | `tests/unit/*.bats` | 218 | 120s | 600s |
...
│   ├── unit/                          # BATS unit tests (218 tests: 11+12+8+5+5+6+20+4+8+7+28+19+7+2+1+5+4+2+3+3+17+41)
