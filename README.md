...
Located at `~/.llm/models.conf` (`$LLM_REGISTRY`) — 19-field pipe-delimited, auto-generated by `model scan`:
...
2|Qwen3-8B|Qwen_Qwen3-8B-Q4_K_M.gguf|4.7G|Q4_K_M/q8_0|qwen2|28|4096|8|1024|256|1|256|llama_server|auto|35.1|yes|no|no
```
