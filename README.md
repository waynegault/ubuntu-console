...
Located at `~/.llm/models.conf` (`$LLM_REGISTRY`) — 20-field pipe-delimited, auto-generated by `model scan`:
...
| Python (kgraph, kgraph-wiring, models, untested-modules, lock-fixture) | `tests/test_*.py` | 204 | 200s |
| **Total** | | **789** | |
