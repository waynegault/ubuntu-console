...
equivalent raw file content.  Accepts ``Graph`` models or legacy
dicts.
"""
...
def benchmark_graph_vs_raw(graph: Graph | dict, source_files: list[str] | None = None, **kwargs) -> dict:
    ...
    Args:
        graph: Graph model or dict with nodes and edges.
    ...
    # Edge: source + target + label + semantic_score ≈ 60 chars ≈ 15 tokens
