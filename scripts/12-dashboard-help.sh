...
function tactical_help() {
    ...
    __hRow "up" "Run 13-step maintenance"
    ...
    __hRow "oc stat" "Full gateway status"
    __hRow "oc health" "Gateway health probe"
    __hRow "oc tail" "Live-tail gateway logs"
    ...
    __hRow "oc start" "Dispatch agent turn"
    ...
    __hRow "oc config" "Read/write config keys"
    __hRow "oc env" "Show OpenClaw env vars"
    __hRow "oc keys" "List Windows API keys"
    __hRow "oc ms" "Probe model endpoints"
    ...
    __hRow "oc backup" "Snapshot to ZIP"
    __hRow "oc restore" "Restore from ZIP"
    ...
    __hRow "gpu-status" "NVIDIA GPU stats"
    ...
    __hRow "burn" "Token stress test (~1300 tokens)"
    ...
    __hRow "wtf [topic]" "Interactive explainer REPL"
